...
if st.session_state.setup_complete and not st.session_state.feedback_shown and not st.session_state.chat_complete:
    ...
    # Initialize OpenAI client. I'm using openrouter.ai's api, hence base_url.
...
if st.session_state.feedback_shown:
    ...
    # Initialize new OpenAI client instance for feedback. I'm using openrouter.ai's api, hence base_url.
    feedback_client = OpenAI(api_key=st.secrets["openrouter_api_key"],
                             base_url=st.secrets["openrouter_base_url"])
